...
const LandingPage = () => {
  ...
  return (
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="pt-24 pb-16 px-4 bg-gradient-to-br from-[#1B0A3F] to-[#52007C]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="bg-[#BF4BF6]/10 backdrop-blur-md rounded-2xl p-8 transform hover:scale-105 transition-transform duration-300">
                  {/* Replace with actual illustration or animation */}
                  <div className="aspect-video bg-gradient-to-br from-[#BF4BF6] to-[#7A00B8] rounded-xl shadow-2xl flex items-center justify-center">
                  <img 
                    src={heroSvg} 
